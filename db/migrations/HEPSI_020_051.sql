-- ============================================================================
-- HEPSI_020_051.sql — 020..024 + 026..051 tek dosyada (BİRLEŞİK, idempotent)
-- ----------------------------------------------------------------------------
...
-- yasak tablolarının Realtime yayınına eklenmesi (anında ban tespiti), ve
-- hesap yasağı ver/kaldır olunca hedefe kalıcı Sistem DM'i (048).
...
-- ==================== [051_rozet_kusanma_kurallari.sql] ====================
