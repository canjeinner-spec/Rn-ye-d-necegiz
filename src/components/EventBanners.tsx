...
/** "Biz Kimiz?" / hikâye banner'ı — emblem + altın parıltı, etkinliklerden ayrı premium görünüm */
function AboutBanner({ b }: { b: EventBanner }) {
  return (
    <View style={styles.banner}>
      <Gradient colors={[b.c1, b.c2]} deg={125} style={StyleSheet.absoluteFill} />
      {/* köşe altın parıltısı */}
        ...
        <View style={{ flex: 1, minWidth: 0 }}>
          <View style={{ flexDirection: "row", alignItems: "center", gap: 7 }}>
            ...
            <View style={styles.tag}>
              <Txt weight="extrabold" size={7.5} color="#1A1206" style={{ letterSpacing: 0.5 }}>HİKÂYE</Txt>
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  glow: { position: "absolute", right: -28, top: -34, width: 150, height: 150, borderRadius: 75, backgroundColor: "rgba(245,206,110,0.16)" },
  tag: { backgroundColor: C.gold2, paddingVertical: 1.5, paddingHorizontal: 6, borderRadius: 5 },
