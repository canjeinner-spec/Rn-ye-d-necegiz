...
const IMG = {
  ...
  // premium set (kullanıcının kendi ürettiği görseller) — daha iyi eşleşen rozetler yükseltildi
  fire: require("@/assets/badges/room/daily_streak.png"),
  medal: require("@/assets/badges/medal.png"),
  military: require("@/assets/badges/military.png"),
  trophy: require("@/assets/badges/room/weekly_champion.png"),
  gstar: require("@/assets/badges/gstar.png"),
  star: require("@/assets/badges/star.png"),
  ring: require("@/assets/badges/room/top_gifter.png"),
  heart: require("@/assets/badges/heart.png"),
  cp: require("@/assets/badges/cp.png"),
  rocket: require("@/assets/badges/room/rising_star.png"),
