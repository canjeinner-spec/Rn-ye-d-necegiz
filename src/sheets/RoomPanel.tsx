...
const styles = StyleSheet.create({
  ...
  odaAvatar: { width: 64, height: 64, borderRadius: 32, overflow: "hidden", borderWidth: 2, borderColor: "rgba(255,255,255,.30)", backgroundColor: C.kontrol },
  ...
  satirGrup: { marginTop: 14, borderRadius: 16, backgroundColor: C.kontrol, borderWidth: 1, borderColor: "rgba(255,255,255,.09)", overflow: "hidden" },
