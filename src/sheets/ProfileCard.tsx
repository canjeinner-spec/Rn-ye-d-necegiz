...
const styles = StyleSheet.create({
  ...
  statStrip: { flexDirection: "row", alignItems: "center", marginTop: 15, borderRadius: 16, backgroundColor: C.kontrol, borderWidth: 1, borderColor: "rgba(255,255,255,.10)" },
  statDivider: { width: StyleSheet.hairlineWidth, height: 26, backgroundColor: "rgba(255,255,255,.14)" },
  bioKutu: { marginTop: 10, borderRadius: 14, paddingVertical: 10, paddingHorizontal: 13, backgroundColor: C.kontrol, borderWidth: 1, borderColor: "rgba(255,255,255,.09)" },
  primaryBtn: { alignItems: "center", justifyContent: "center", gap: 5, paddingVertical: 11, borderRadius: 14, backgroundColor: C.kartUst, borderWidth: 1, borderColor: "rgba(255,255,255,.13)" },
  actionGroup: { borderRadius: 14, backgroundColor: C.kontrol, borderWidth: 1, borderColor: "rgba(255,255,255,.10)", overflow: "hidden" },
