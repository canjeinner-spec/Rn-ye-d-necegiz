...
export default function AdminBannerEdit() {
  ...
  const pickFoto = async () => {
    ...
    try {
      ...
      const res = await ImagePicker.launchImageLibraryAsync({ mediaTypes: ["images"], allowsEditing: true, aspect: [7, 2], quality: 0.85, base64: true });
...
const styles = StyleSheet.create({
  ...
  sablonChip: { flex: 1, alignItems: "center", paddingVertical: 12, borderRadius: 14, backgroundColor: C.kart, borderWidth: 1, borderColor: "rgba(255,255,255,.08)" },
  ...
  preview: { width: "100%", aspectRatio: BANNER_ORAN, borderRadius: 12, overflow: "hidden", borderWidth: 1, borderColor: C.line, backgroundColor: C.kart },
