...
const styles = StyleSheet.create({
  ...
  altBtn: { flexDirection: "row", alignItems: "center", gap: 6, paddingVertical: 9, paddingHorizontal: 16, borderRadius: 12, borderWidth: 1, borderColor: "rgba(255,255,255,.12)", backgroundColor: C.kontrol },
  ...
  kapsulCell: { width: 104, alignItems: "center", gap: 3, paddingVertical: 6, paddingHorizontal: 4, borderRadius: 12, borderWidth: 1, borderColor: C.line, backgroundColor: C.kart },
  bannerGrid: { flexDirection: "row", flexWrap: "wrap", gap: 8, justifyContent: "center", marginTop: 12 },
  bannerCell: { alignItems: "center", padding: 6, borderRadius: 12, borderWidth: 1, borderColor: C.line, backgroundColor: C.kart },
  tipRow: { flexDirection: "row", gap: 8, marginTop: 14 },
  tipBtn: { flex: 1, alignItems: "center", paddingVertical: 10, borderRadius: 12, borderWidth: 1, borderColor: C.line, backgroundColor: C.kart },
