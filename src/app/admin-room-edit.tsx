        ...
        {loading ? (
          ...
          <ScrollView contentContainerStyle={{ paddingHorizontal: 18, paddingTop: 12, paddingBottom: 32 }} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
            ...
            */}
            ...
            <Pressable onPress={() => { router.navigate(`/admin-mesaj?tip=oda&odaId=${odaId}`); }} style={[styles.group, { flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 13, paddingHorizontal: 14, marginTop: 12 }]}>
...
const styles = StyleSheet.create({
  ...
  kapakOnizleme: { width: 62, height: 62, borderRadius: 16, overflow: "hidden", backgroundColor: C.kontrol, borderWidth: 1, borderColor: "rgba(255,255,255,.10)" },
  ...
  hIcon: { width: 30, height: 30, borderRadius: 9, alignItems: "center", justifyContent: "center", backgroundColor: C.kontrol },
});
