...
const styles = StyleSheet.create({
  ...
  kingCard: { flex: 1, alignItems: "center", paddingVertical: 12, paddingHorizontal: 6, borderRadius: 16, backgroundColor: C.kontrol, borderWidth: 1 },
  ...
  tabOff: { backgroundColor: C.kontrol, borderWidth: 1.5, borderColor: C.gold2 + "55" },
  grid: { flexDirection: "row", flexWrap: "wrap", gap: 12, paddingHorizontal: 16 },
  card: { width: "47%", flexGrow: 1, borderRadius: 16, overflow: "hidden", borderWidth: 1.5, backgroundColor: C.kart },
