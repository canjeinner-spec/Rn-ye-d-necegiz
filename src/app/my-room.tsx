...
const styles = StyleSheet.create({
  ...
  card: { flexDirection: "row", alignItems: "center", gap: 13, padding: 12, borderRadius: 18, marginBottom: 10, backgroundColor: C.kart, borderWidth: 1, borderColor: "rgba(255,255,255,.08)" },
