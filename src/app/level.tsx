...
const styles = StyleSheet.create({
  ...
  barFill: { height: "100%" },
  xpCard: { flexDirection: "row", marginHorizontal: 16, marginTop: 16, borderRadius: 16, backgroundColor: C.kart, borderWidth: 1, borderColor: "rgba(255,255,255,.07)", overflow: "hidden" },
  xpCol: { flex: 1, alignItems: "center", paddingVertical: 14, paddingHorizontal: 8 },
  xpDivider: { width: 1, backgroundColor: C.kartUst },
  ...
  wayRow: { flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 13, paddingHorizontal: 14, borderRadius: 14, backgroundColor: C.kart, borderWidth: 1, borderColor: "rgba(255,255,255,.07)", marginTop: 8 },
