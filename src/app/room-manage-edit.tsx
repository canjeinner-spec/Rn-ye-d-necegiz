...
const styles = StyleSheet.create({
  ...
  coverWrap: { width: "100%", maxWidth: 340, alignSelf: "center" },
  coverPreview: { width: "100%", aspectRatio: 16 / 9, borderRadius: 16, overflow: "hidden", borderWidth: 1, borderColor: C.line, backgroundColor: "rgba(255,255,255,.04)" },
  camBadge: { position: "absolute", right: 10, bottom: 10, width: 30, height: 30, borderRadius: 15, backgroundColor: C.gold2, borderWidth: 2.5, borderColor: "#08080C", alignItems: "center", justifyContent: "center" },
