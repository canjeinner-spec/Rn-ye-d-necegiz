...
const styles = StyleSheet.create({
  ...
  hero: { alignItems: "center", paddingVertical: 26, paddingHorizontal: 20, borderRadius: 24, overflow: "hidden", borderWidth: 1, borderColor: "rgba(255,255,255,.12)", backgroundColor: "rgba(255,255,255,.03)" },
  ...
  row: { flexDirection: "row", alignItems: "center", gap: 13, padding: 14, borderRadius: 16, backgroundColor: "rgba(255,255,255,.04)", borderWidth: 1, borderColor: C.line, marginBottom: 10 },
