...
const styles = StyleSheet.create({
  ...
  rulesBtn: { height: 30, paddingHorizontal: 12, borderRadius: 10, backgroundColor: C.kontrol, alignItems: "center", justifyContent: "center" },
  tabs: { flexDirection: "row", gap: 8, marginHorizontal: 16, marginTop: 6, backgroundColor: C.kontrol, borderRadius: 14, padding: 4 },
  ...
  statCard: { flex: 1, minWidth: 0, borderRadius: 18, padding: 14, borderWidth: 1, backgroundColor: C.kart, overflow: "hidden" },
  quick: { flex: 1, alignItems: "center", gap: 8, paddingVertical: 14, paddingHorizontal: 8, borderRadius: 16, borderWidth: 1, backgroundColor: C.kart, overflow: "hidden" },
  quickIcon: { width: 36, height: 36, borderRadius: 12, alignItems: "center", justifyContent: "center", borderWidth: 1 },
  ledgerGroup: { borderRadius: 18, backgroundColor: C.kart, borderWidth: 1, borderColor: "rgba(255,255,255,.08)", overflow: "hidden" },
  ledgerRow: { flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 12, paddingHorizontal: 13 },
  ledgerDivider: { height: StyleSheet.hairlineWidth, backgroundColor: C.kartUst, marginLeft: 65 },
