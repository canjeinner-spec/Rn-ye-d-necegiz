...
const styles = StyleSheet.create({
  ...
  back: { position: "absolute", left: 20, top: 8, zIndex: 2, width: 34, height: 34, borderRadius: 12, borderWidth: 1, borderColor: C.line, backgroundColor: C.kontrol, alignItems: "center", justifyContent: "center" },
  altBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 9, paddingVertical: 13, borderRadius: 15, borderWidth: 1, borderColor: "rgba(255,255,255,.1)", backgroundColor: C.kontrol },
  kayitScroll: { paddingHorizontal: 30, paddingTop: 24, paddingBottom: 34 },
  bio: { minHeight: 92, marginTop: 8, borderWidth: 1, borderColor: "rgba(255,255,255,.1)", borderRadius: 14, paddingHorizontal: 14, paddingTop: 12, paddingBottom: 12, backgroundColor: C.kontrol, color: C.text, fontSize: 14, lineHeight: 20, fontFamily: "PlusJakartaSans_700Bold", textAlignVertical: "top" },
  ayirici: { flexDirection: "row", alignItems: "center", gap: 10, marginTop: 26, marginBottom: 12 },
  cizgi: { flex: 1, height: 1, backgroundColor: C.kartUst },
