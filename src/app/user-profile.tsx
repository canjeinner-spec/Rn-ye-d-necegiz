...
const styles = StyleSheet.create({
  ...
  statDivider: { width: 1, height: 28, backgroundColor: C.kartUst },
  ...
  bilgiGrup: { borderRadius: 16, backgroundColor: C.kontrol, borderWidth: 1, borderColor: "rgba(255,255,255,.08)", paddingHorizontal: 14, marginTop: 8 },
  bilgiAyirici: { height: StyleSheet.hairlineWidth, backgroundColor: C.kartUst },
  ...
  barBtn: { flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 7, paddingVertical: 13, borderRadius: 14, backgroundColor: C.kontrol, borderWidth: 1, borderColor: "rgba(255,255,255,.13)" },
  barBtnPrimary: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 7, paddingVertical: 13, borderRadius: 14 },
  blockNotice: { flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 7, paddingVertical: 13, paddingHorizontal: 12, borderRadius: 14, backgroundColor: C.kart, borderWidth: 1, borderColor: C.line },
  ...
  addInput: { flexDirection: "row", alignItems: "center", gap: 8, backgroundColor: C.kontrol, borderWidth: 1, borderColor: C.line, borderRadius: 14, paddingVertical: 12, paddingHorizontal: 14 },
