...
const styles = StyleSheet.create({
  ...
  raporKart: { padding: 14, borderRadius: 18, marginBottom: 16, backgroundColor: C.kart, borderWidth: 1.5, borderColor: "rgba(251,113,133,.34)" },
  detayKutu: { marginTop: 12, paddingVertical: 11, paddingHorizontal: 13, borderRadius: 14, backgroundColor: C.kontrol, borderWidth: 1, borderColor: "rgba(255,255,255,.09)" },
