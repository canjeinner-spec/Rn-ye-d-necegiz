...
const styles = StyleSheet.create({
  ...
  statStrip: { flexDirection: "row", alignItems: "center", marginTop: 16, borderRadius: 18, backgroundColor: C.kart, borderWidth: 1, borderColor: "rgba(255,255,255,.08)" },
  ...
  tileRow: { flexDirection: "row", justifyContent: "space-between", marginTop: 14, backgroundColor: C.kart, borderWidth: 1, borderColor: "rgba(255,255,255,.08)", borderRadius: 20, paddingVertical: 16, paddingHorizontal: 8 },
  wallet: { flexDirection: "row", alignItems: "center", marginTop: 12, backgroundColor: C.kart, borderWidth: 1, borderColor: C.gold + "2E", borderRadius: 18, paddingVertical: 12, paddingHorizontal: 14, overflow: "hidden" },
  streamerToggle: { flexDirection: "row", alignItems: "center", gap: 8, marginTop: 14, backgroundColor: C.kart, borderWidth: 1, borderStyle: "dashed", borderColor: C.line, borderRadius: 14, paddingVertical: 10, paddingHorizontal: 14 },
  ...
  menuGroup: { marginTop: 12, backgroundColor: C.kart, borderWidth: 1, borderColor: "rgba(255,255,255,.08)", borderRadius: 20, padding: 6 },
